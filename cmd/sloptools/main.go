...
func printHelp() {
	...
	fmt.Println("brain subcommands: search backlinks gtd people folder entities glossary attention links vault ingest move cleanup-dead-dirs consolidate dream archive sleep")
