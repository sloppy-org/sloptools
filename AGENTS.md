...
- `internal/meetings`: per-person meeting-note parser with stable comment-anchored task IDs, owner alias / brain-people resolver, legacy-importer ref shim, INBOX backfill walker, canonical-host voice-memo watcher and the audio classify/transcribe/render pipeline.
