...
func init() {
	MCPTools = append(MCPTools,
		Tool{Name: "brain.note.parse", Description: "Parse a brain note from the configured work/private vault and return structured content plus source-path metadata.", Required: []string{"sphere", "path"}, Properties: map[string]ToolProperty{
			...
			"path":        {Type: "string", Description: "Brain-relative or absolute note path."},
		}},
		...
		Tool{Name: "brain.note.write", Description: "Round-trip safe update of a brain note's front matter and sections. Sections are upserted: existing sections are updated in place, new ones are appended at the end.", Required: []string{"sphere", "path", "fields"}, Properties: map[string]ToolProperty{
			...
			"sphere":      {Type: "string", Description: "Vault sphere to inspect.", Enum: []string{"work", "private"}},
			"path":        {Type: "string", Description: "Brain-relative or absolute note path."},
			"fields":      {Type: "object", Description: "Field updates: frontmatter plus sections; missing sections are appended."},
		}},
		...
		Tool{Name: "brain.gtd.review_list", Description: "Return a normalized GTD review list across Markdown commitments, task providers, and issue sources without materializing duplicate Markdown notes. The response includes an over_wip slice of tracks whose open next count exceeds the wip_limit configured in gtd.toml.", Required: []string{"sphere"}, Properties: map[string]ToolProperty{
			...
			"sources":          {Type: "array", Description: "Source classes; defaults to markdown, mail, github, gitlab."},
			...
			"queue":            {Type: "string", Description: "Optional GTD queue filter.", Enum: []string{"inbox", "next", "in_progress", "waiting", "delegated", "deferred", "review", "someday", "done"}},
