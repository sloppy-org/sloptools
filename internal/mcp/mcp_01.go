...
func (s *Server) callTool(name string, args map[string]interface{}) (map[string]interface{}, error) {
	...
	case "brain.note.parse", "brain.note.validate", "brain.vault.validate", "brain.links.resolve", "brain_search", "brain_backlinks", "brain.gtd.dedup_scan", "brain.gtd.dedup_review_apply", "brain.gtd.dedup_history":
