...
func TestSessionSendTurnInputWithParams_UsesExplicitImageInput(t *testing.T) {
	...
	defer sess.Close()
	_, err = sess.SendTurnInputWithParams(ctx, BuildTurnInput([]TurnInputItem{{Type: "text", Text: "inspect this"}, {Type: "image_url", ImageURL: "data:image/png;base64,Zm9v"}}), "", nil, nil)
	if err != nil {
...
func TestSessionClosedAfterError(t *testing.T) {
	srv := newTestServer(t, func(conn *websocket.Conn, msg map[string]interface{}, _ int) {
		_ = conn.WriteJSON(map[string]interface{}{"id": msg["id"], "error": map[string]interface{}{"message": "model overloaded"}})
	})
	defer srv.Close()
	wsURL := "ws" + strings.TrimPrefix(srv.URL, "http")
	client, err := NewClient(wsURL)
...
func TestSessionItemCompletedForwarding(t *testing.T) {
	srv := newTestServer(t, func(conn *websocket.Conn, msg map[string]interface{}, _ int) {
		id := msg["id"]
		_ = conn.WriteJSON(map[string]interface{}{"id": id, "result": map[string]interface{}{"turn": map[string]interface{}{"id": "turn-edit"}}})
		_ = conn.WriteJSON(map[string]interface{}{"method": "item/completed", "params": map[string]interface{}{"item": map[string]interface{}{"type": "fileChange", "file": "src/main.go"}}})
		_ = conn.WriteJSON(map[string]interface{}{"method": "item/completed", "params": map[string]interface{}{"item": map[string]interface{}{"type": "fileChange", "path": "src/util.go"}}})
		_ = conn.WriteJSON(map[string]interface{}{"method": "item/completed", "params": map[string]interface{}{"item": map[string]interface{}{"type": "agentMessage", "text": "done editing"}}})
		_ = conn.WriteJSON(map[string]interface{}{"method": "turn/completed", "params": map[string]interface{}{"turn": map[string]interface{}{"id": "turn-edit", "status": "completed"}}})
	})
	defer srv.Close()
	wsURL := "ws" + strings.TrimPrefix(srv.URL, "http")
	client, err := NewClient(wsURL)
...
func TestSessionCompactEvent(t *testing.T) {
	srv := newTestServer(t, func(conn *websocket.Conn, msg map[string]interface{}, _ int) {
		id := msg["id"]
		_ = conn.WriteJSON(map[string]interface{}{"id": id, "result": map[string]interface{}{"turn": map[string]interface{}{"id": "turn-compact"}}})
		_ = conn.WriteJSON(map[string]interface{}{"method": "codex/event/context_compact", "params": map[string]interface{}{}})
		_ = conn.WriteJSON(map[string]interface{}{"method": "item/completed", "params": map[string]interface{}{"item": map[string]interface{}{"type": "agentMessage", "text": "compacted reply"}}})
		_ = conn.WriteJSON(map[string]interface{}{"method": "turn/completed", "params": map[string]interface{}{"turn": map[string]interface{}{"id": "turn-compact", "status": "completed"}}})
	})
	defer srv.Close()
	wsURL := "ws" + strings.TrimPrefix(srv.URL, "http")
	client, err := NewClient(wsURL)
