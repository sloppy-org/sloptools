...
func TestParseExchangeContact(t *testing.T) {
	contact := parseExchangeContact(exchangeContact{ID: "contact-1", DisplayName: "Carol Example", CompanyName: "Example Corp", EmailAddresses: []exchangeAddress{{Address: "Carol@example.com"}}, BusinessPhones: []string{"+1 555 0110"}})
	if contact == nil {
