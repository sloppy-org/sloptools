...
func buildScoutPacket(brainRoot string, p Pick) string {
	...
	b.WriteString(strings.Join([]string{
		...
		"Use sloppy `sloppy_brain`, `sloppy_contacts`, `sloppy_calendar`, `sloppy_mail`, and `sloppy_source` for vault, groupware, and GitHub issue/PR/code cross-checks before public web; for GitHub pass an explicit `repo` owner/name so the lookup hits the intended project.",
